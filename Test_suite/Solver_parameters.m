...
%% Global parameters
% Define some parameters as global variables to more easily call the 
% methods several times with different parameter values in file
%   Test_suite/Run_tests.m
...
parameters.log_location = "tira_test.log";
...
%     This method applies the discrete-time mixed-monotonicity method (5) to
%     the sampled-data version of a continuous-time system.
...
parameters.OA_method = NaN;
    ...
    parameters.sensitivity_bounds_method = g_sensitivity_bounds_method;
        ...
        parameters.taylor_increment = 10;
        ...
        parameters.falsification_max_iter = 2;     
    ...
    %       best available method (in the above order) based on provided 
    %       files in './Input_files' folder
    parameters.error_bound_method = g_error_bound_method;
