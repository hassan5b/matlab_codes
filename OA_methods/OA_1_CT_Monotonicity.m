...
%
% To avoid checking the satisfaction of the monotonicity property, the more
...
[~,x_traj_low] = ode_solver(@(t,x) System_description(t, x, p_low_PO), [t_init, t_final], x_low_PO, ode_options);
...
[~,x_traj_up] = ode_solver(@(t,x) System_description(t, x, p_up_PO), [t_init, t_final], x_up_PO, ode_options);
